This code is a program that helps you keep track of your finances. It allows you to enter the income and expenses for each month and then calculates the net 
...
The program prompts you to enter the month, income and expenses until you decide to stop by entering 'q' as month. After that it displays all the data in a 
tabular format showing the month, income, expenses and net income for each month.
